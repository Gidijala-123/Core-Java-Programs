<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
   ...
   <head>
      ...
      <title>GBR's Signup & Login form</title>
   </head>
      ...
      <div class="container">
         ...
         <div class="form">
            <div class="sign-in" id="sign-in-info">
               ...
               <form id="sign-in-form" action="loginAction.jsp" method="post">
                  <input type="email" name="email" placeholder="Enter email id" required>
                  <input type="password" name="password" placeholder="Enter password" required>
                  <a class="forgot-password" href="forgotPassword.jsp">Forgot your password?</a>
                  ...
                  <button type="submit" value="login" class="control-button in">Sign In</button>
               </form>
            </div>

            <div class="sign-up" id="sign-up-info">
               <h1>Create Account</h1>
               <form id="sign-up-form" action="signupAction.jsp" method="post">
                  ...
                  <input type="number" name="smobileNumber" placeholder="Enter mobile number" required>
                  <select name="ssecurityQuestion" required>
                  ...
                  </select> <input type="text" name="sanswer" placeholder="Enter answer" required>
                  <input type="password" name="spassword" placeholder="Enter password" required>
                  <button type=submit value="signup" class="control-button up">Sign Up</button>
               </form>
            </div>
         </div>
      </div>
