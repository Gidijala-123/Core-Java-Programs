...
public class AdventureModel {
 ...
 rooms[6] = new Room("Astapor","Astapor contains pick up items, Required command,Gold and Boat");
 rooms[6].addObject(things[0]);
 rooms[6].addObject(things[5]);
 
 rooms[7] = new Room("Dragon Stone","Dragon Stone contains pick up items, Required command,Dragon and Banner");
 rooms[7].addObject(things[1]);
 rooms[7].addObject(things[2]);
 
 rooms[8] = new Room("The Vale","The Vale contains pick up items, Required command,Food and Banner");
 rooms[8].addObject(things[3]);
 rooms[8].addObject(things[2]);
 
 rooms[9] = new Room("Castle Black","Castle Black contains pick up items, Required command,Dragon Glass and 2 Banner");
